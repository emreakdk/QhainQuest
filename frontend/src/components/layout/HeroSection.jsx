  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 dark:from-slate-800 dark:via-purple-800 dark:to-slate-800">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        ...
        <p className="text-base sm:text-sm md:text-base lg:text-lg text-slate-300 mb-4 sm:mb-6 md:mb-8 lg:mb-12 max-w-4xl mx-auto leading-relaxed px-2">
          {t('home.subtitle')}
        </p>
        ...
        <div className="mt-6 sm:mt-8 md:mt-12 lg:mt-16 xl:mt-20">
          ...
          <div className="flex flex-col md:grid md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            <div className="text-center group p-3 sm:p-4 md:p-6">
              ...
              <h3 className="text-xl sm:text-lg md:text-xl font-semibold text-white mb-1 sm:mb-2 leading-tight">{t('features.nftCertificates')}</h3>
              <p className="text-base sm:text-sm md:text-base text-slate-300 leading-relaxed">{t('features.nftCertificatesDesc')}</p>
            </div>
            ...
            <div className="text-center group p-3 sm:p-4 md:p-6">
              ...
              <h3 className="text-xl sm:text-lg md:text-xl font-semibold text-white mb-1 sm:mb-2 leading-tight">{t('features.tokenRewards')}</h3>
              <p className="text-base sm:text-sm md:text-base text-slate-300 leading-relaxed">{t('features.tokenRewardsDesc')}</p>
            </div>
            ...
            <div className="text-center group p-3 sm:p-4 md:p-6">
              ...
              <h3 className="text-xl sm:text-lg md:text-xl font-semibold text-white mb-1 sm:mb-2 leading-tight">{t('features.competition')}</h3>
              <p className="text-base sm:text-sm md:text-base text-slate-300 leading-relaxed">{t('features.competitionDesc')}</p>
            </div>
          </div>
        </div>
      </div>
