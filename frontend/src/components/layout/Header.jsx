        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className={`w-10 h-10 rounded-lg transition-colors flex items-center justify-center cursor-pointer ${
              (publicKey || isDemoMode) 
                ? 'bg-slate-100/50 dark:bg-slate-800/50 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 hover:text-white dark:hover:text-slate-300'
                : 'bg-slate-100/50 dark:bg-slate-800/50 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 hover:text-white dark:hover:text-slate-300'
            }`}
